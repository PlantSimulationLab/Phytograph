...
| Translate / rotate / scale | Select the mesh and click **Transform** in the Tools toolbar, or the **⤢** (double-arrow) button on the mesh's row in the Meshes panel — both open its Transform panel |
